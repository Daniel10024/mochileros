...
<br>
        <div class="card">
                ...
                <div class="avatar">
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <input type="text" id="nom-form" disabled="" name="nombre" value="Pepe Jamon" class="form-control" placeholder="Nombre"  />
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <input type="text" id="con-form" disabled="" name="nombre" value="contactame esta <3" class="form-control" placeholder="Nombre"  />
