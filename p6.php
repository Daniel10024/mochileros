...
<div class="hidden"> <!-- esto esta hidden _________________________________________________________________________ -->
        ...
        <section class="">
          ...
          <div class="row">
            <div class="col-xs-8 col-xs-offset-2">
              <a href="p4.php"><button id="buscar" type="button" class="botonBuscarFondoPantalla btn btn-lg  btn-block btn-danger">Atras</button></a>
            </div>
          </div>
</div><!-- aca termina el hidden__________________________________________________________________________ -->
        </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title custom_align" id="Heading">Eliminar punto</h4>
                  </div>
                     <div class="modal-body">
